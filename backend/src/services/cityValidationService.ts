...
import { CityRecord, ValidationResult, GameMove } from '../types';
import { normalizeCityName, extractNextLetter } from '../utils/gameUtils';
...
export class CityValidationService {
  ...
  private async createSampleDatabase(dbPath: string): Promise<void> {
    ...
    const sampleCities: CityRecord[] = [
      { name: 'Aberdeen', normalizedName: 'aberdeen', displayName: 'Aberdeen', country: 'Scotland', source: 'custom' },
      { name: 'Newark', normalizedName: 'newark', displayName: 'Newark', country: 'United States', source: 'custom' },
      { name: 'Kinshasa', normalizedName: 'kinshasa', displayName: 'Kinshasa', country: 'DR Congo', source: 'custom' },
      { name: 'Ann Arbor', normalizedName: 'ann arbor', displayName: 'Ann Arbor', country: 'United States', source: 'custom' },
      { name: 'Rochester', normalizedName: 'rochester', displayName: 'Rochester', country: 'United States', source: 'custom' },
      { name: 'New York City', normalizedName: 'new york city', displayName: 'New York City', country: 'United States', source: 'custom' },
      { name: 'Kansas City', normalizedName: 'kansas city', displayName: 'Kansas City', country: 'United States', source: 'custom' },
      { name: 'York', normalizedName: 'york', displayName: 'York', country: 'United Kingdom', source: 'custom' },
      { name: 'Tokyo', normalizedName: 'tokyo', displayName: 'Tokyo', country: 'Japan', source: 'custom' },
      { name: 'Oslo', normalizedName: 'oslo', displayName: 'Oslo', country: 'Norway', source: 'custom' },
      { name: 'London', normalizedName: 'london', displayName: 'London', country: 'United Kingdom', source: 'custom' },
      { name: 'Nairobi', normalizedName: 'nairobi', displayName: 'Nairobi', country: 'Kenya', source: 'custom' },
      { name: 'Istanbul', normalizedName: 'istanbul', displayName: 'Istanbul', country: 'Turkey', source: 'custom' },
      { name: 'Los Angeles', normalizedName: 'los angeles', displayName: 'Los Angeles', country: 'United States', source: 'custom' },
      { name: 'Seattle', normalizedName: 'seattle', displayName: 'Seattle', country: 'United States', source: 'custom' },
      { name: 'Edmonton', normalizedName: 'edmonton', displayName: 'Edmonton', country: 'Canada', source: 'custom' },
      { name: 'Naples', normalizedName: 'naples', displayName: 'Naples', country: 'Italy', source: 'custom' },
      { name: 'Sydney', normalizedName: 'sydney', displayName: 'Sydney', country: 'Australia', source: 'custom' },
      { name: 'Yerevan', normalizedName: 'yerevan', displayName: 'Yerevan', country: 'Armenia', source: 'custom' },
      { name: 'Nicosia', normalizedName: 'nicosia', displayName: 'Nicosia', country: 'Cyprus', source: 'custom' },
    ];
  ...
  validateCity(
    ...
    if (isDuplicate) {
      duplicateMove = gameHistory.find(
